...
- **JSON-структура** — массив элементов по страницам: `type` (text, image, table, stamp, signature), `bbox` [x1, y1, x2, y2] в нормализованных координатах 0–1000 относительно ширины/высоты страницы, `text`/`content`.
